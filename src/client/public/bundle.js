...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NodeList = __webpack_require__(/*! ./NodeList.jsx */ 159);
	
	var _NodeList2 = _interopRequireDefault(_NodeList);
	
	var _ClusterHealth = __webpack_require__(/*! ./ClusterHealth.jsx */ 161);
	
	var _ClusterHealth2 = _interopRequireDefault(_ClusterHealth);
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    var that = _this;
	    _this.state = { nodes: {}, nodesPerformance: [] };
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_ClusterHealth2.default, { health: this.state.clusterHealth }),
	        _react2.default.createElement(_NodeList2.default, { nodes: this.state.nodes, performance: this.state.nodesPerformance })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NodeListItem = __webpack_require__(/*! ./NodeListItem.jsx */ 160);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        Object.keys(this.props.nodes).map(function (nodeName, i) {
	          return _react2.default.createElement(_NodeListItem2.default, { key: i, node: _this2.props.nodes[nodeName], performance: _this2.props.performance ? _this2.props.performance[nodeName] : null });
	        })
	      );
	    }
	  }]);
...
/* 160 */
/*!*****************************************!*\
  !*** ./src/client/app/NodeListItem.jsx ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var NodeListItem = function (_React$Component) {
	  _inherits(NodeListItem, _React$Component);
	
	  function NodeListItem(props) {
	    _classCallCheck(this, NodeListItem);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NodeListItem).call(this, props));
	
	    _this.isMaster.bind(_this);
	    _this.isData.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(NodeListItem, [{
	    ...
	    value: function render() {
	      ...
	      if (this.props.performance) {
	        ...
	        performance_info = _react2.default.createElement(
	          'table',
	          null,
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'td',
	                { className: this.props.performance.jvm.mem.heap_used_percent > 80 ? 'red' : '' },
	                this.props.performance.jvm.mem.heap_used_percent + "%"
	              )
	            ),
	            _react2.default.createElement(
	              'tr',
	              ...
	              _react2.default.createElement(
	                'td',
	                null,
	                this.props.performance.os.load_average[0]
	              )
	            ),
	            _react2.default.createElement(
	              'tr',
	              ...
	              _react2.default.createElement(
	                'td',
	                { className: this.props.performance.fs.total.available_in_bytes < 10000000000 ? 'red' : '' },
	                Math.round(this.props.performance.fs.total.available_in_bytes / 1000000000),
	                'gb'
	              )
	            ),
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'td',
	                { className: percentFileDescriptors > 80 ? 'red' : '', title: this.props.performance.process.open_file_descriptors },
	                Math.round(percentFileDescriptors * 1000) / 1000,
	                ' %'
	              )
	            ),
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'td',
	                null,
	                (0, _Utils2.default)(this.props.performance.indices.docs.count)
	              )
	            ),
	            _react2.default.createElement(
	              'tr',
	              ...
	              _react2.default.createElement(
	                'td',
	                null,
	                (0, _Utils2.default)(this.props.performance.indices.segments.count)
	              )
	            )
	          )
	        );
	      ...
	      return _react2.default.createElement(
	        'div',
	        { style: { float: 'left', width: '150px' }, className: this.isMaster() ? 'master' : this.isData() ? 'data' : 'client' },
	        _react2.default.createElement(
	          'b',
	          null,
...
/* 161 */
/*!******************************************!*\
  !*** ./src/client/app/ClusterHealth.jsx ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var ClusterHealth = function (_React$Component) {
	  _inherits(ClusterHealth, _React$Component);
	
	  function ClusterHealth() {
	    _classCallCheck(this, ClusterHealth);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ClusterHealth).apply(this, arguments));
	  }
	
	  _createClass(ClusterHealth, [{
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h1',
	          { className: this.props.health.status },
	          this.props.health.cluster_name
	        ),
	        _react2.default.createElement(
	          'div',
	          null,
	          'Relocating: ',
	          this.props.health.relocating_shards
	        ),
	        _react2.default.createElement(
	          'div',
	          null,
	          'Unassigned: ',
	          this.props.health.unassigned_shards
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: this.props.health.number_of_pending_tasks > 150 ? 'red' : '' },
	          'Pending tasks: ',
	          this.props.health.number_of_pending_tasks
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	function prettyNumber(num, digits) {
